...
# A BED file of regions with exome coverage. Coverage estimation will only include these regions.
BED_FILE="/panfs/roc/groups/9/morrellp/shared/References/Reference_Sequences/Barley/Morex_v3/captured_50x_morex_v3_partsRef.bed"
...
do
    ...
    mosdepth --by ${BED_FILE} --threads 4 --fast-mode --fasta ${REF_FASTA} --no-per-base ${SAMPLE_NAME} ${i}
done
