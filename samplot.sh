...
GFF3=/panfs/roc/groups/9/morrellp/shared/References/Reference_Sequences/Barley/Morex_v2/gene_annotation/Barley_Morex_V2_gene_annotation_PGSB.all.parts.sorted.gff3.gz

#Samplot command line
samplot vcf \
--vcf ${VCF} \
--sample_ids Morex_Nanopore Morex_10X M01_Nanopore M01_10X \
--out-dir ${OUT_DIR} \
--output_type png \
--gff3 ${GFF3} \
